...
export const SECTIONS: Record<string, SectionDef> = {
  ...
  services: {
    ...
    defaults: {
      ...
      services: [
        { number: '01', title: 'Retention Infrastructure Setup', items: 'Email + SMS system, CRM & segmentation, Tracking & analytics', accent: '#C9A227' },
  ...
  results: {
    ...
    defaults: {
      ...
      outcomes: [
        ...
        { text: 'Increased profitability', icon: '●', color: '#C9A227' },
  ...
  process: {
    ...
    defaults: {
      ...
      steps: [
        { number: '01', title: 'Growth Audit', description: 'We dig into your data to find exactly where revenue is slipping through the cracks.', deliverables: 'Revenue leak analysis, Customer journey mapping, Competitor benchmarking, 30-day action plan', accent: '#C9A227' },
