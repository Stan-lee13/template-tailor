        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          <div className="md:col-span-5">
            ...
            <button
              ...
              style={{ background: '#F97316', padding: '10px 22px', borderRadius: '9999px', fontSize: '13.5px' }}
            >
              Book a free audit
            </button>
            <div className="flex items-center gap-4 mt-6">
              <a href={SITE.social.linkedin} target="_blank" rel="noopener noreferrer" className="transition-colors duration-300" style={{ color: '#8A8A8A' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#f1ece4')} onMouseLeave={(e) => (e.currentTarget.style.color = '#8A8A8A')} aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href={SITE.social.twitter} target="_blank" rel="noopener noreferrer" className="transition-colors duration-300" style={{ color: '#8A8A8A' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#f1ece4')} onMouseLeave={(e) => (e.currentTarget.style.color = '#8A8A8A')} aria-label="Twitter">
              ...
              <a href={`mailto:${SITE.email}`} className="transition-colors duration-300 font-inter text-sm" style={{ color: '#8A8A8A' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#f1ece4')} onMouseLeave={(e) => (e.currentTarget.style.color = '#8A8A8A')}>
                {SITE.email}
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-col gap-3">
              {serviceLinks.map((link) => (
                <Link key={link.label} to={link.href} className="font-inter text-sm transition-colors duration-300" style={{ color: 'rgba(241,236,228,0.6)' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#f1ece4')} onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(241,236,228,0.6)')}>
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          <div className="md:col-span-2">
            <h4 className="font-inter font-medium uppercase mb-5" style={{ fontSize: '12px', color: '#8A8A8A', letterSpacing: '0.04em' }}>Legal</h4>
            <div className="flex flex-col gap-3">
              {legalLinks.map((link) => (
                <Link key={link.label} to={link.to} className="font-inter text-sm transition-colors duration-300" style={{ color: 'rgba(241,236,228,0.6)' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#f1ece4')} onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(241,236,228,0.6)')}>
                  {link.label}
