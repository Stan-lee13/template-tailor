      ...
      <main className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <header className="mb-20 lg:mb-32">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#C9A227] mb-6">Intelligence Hub</p>
          ...
          {loading ? (
            ...
            <div className="space-y-8">
              {featured && (
                <Link to={`/blog/${featured.slug}`} className="group relative block rounded-[2.5rem] overflow-hidden bg-white/[0.03] border border-white/10 hover:border-[#C9A227]/30 transition-all duration-700">
                  ...
                  <div className="relative z-10 p-10 lg:p-20">
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#C9A227] mb-8">Priority Intelligence</p>
                    ...
                    <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-white/20">
                      ...
                      <span className="text-[#C9A227]">Read Protocol →</span>
                    </div>
                  </div>
                </Link>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {rest.map((p) => (
                  <Link key={p.id} to={`/blog/${p.slug}`} className="group relative rounded-[2.5rem] overflow-hidden bg-white/[0.03] border border-white/10 hover:border-[#C9A227]/30 transition-all duration-700 flex flex-col">
                    ...
                    <div className="p-10 lg:p-12 flex-1 flex flex-col">
                      <h3 className="text-2xl lg:text-3xl font-black text-white tracking-tighter mb-6 leading-none group-hover:text-[#C9A227] transition-colors duration-500">{p.title}</h3>
                      ...
                      <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-white/20">
                        ...
                        <span className="text-[#C9A227] opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-500">Read Protocol →</span>
                      </div>
                    </div>
                  </Link>
                ))}
