    ...
    <div className="rf-secondary-shell rf-secondary-shell--thank-you min-h-screen selection:bg-[#C56A4A] selection:text-black">
      ...
      <main className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#C56A4A]/10 blur-[120px] rounded-full animate-pulse" />
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="text-center mb-20">
            <div className="mx-auto mb-10 w-20 h-20 rounded-3xl bg-[#C56A4A] flex items-center justify-center shadow-[0_0_40px_rgba(197,106,74,0.3)] rotate-3">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-white tracking-tighter mb-8 leading-[0.9]">
              Audit <span className="text-gradient-warm">Secured.</span>
            </h1>
            ...
            <div className="space-y-10">
              {[
                ...
                <div key={i} className="flex gap-8 group/item">
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-lg font-black text-white group-hover/item:bg-[#C56A4A] group-hover/item:text-black transition-all duration-500">
                    0{i + 1}
                  </div>
                  <div className="pt-1">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-16">
            <div className="rounded-[2rem] p-8 bg-black border border-white/10 hover:border-[#C56A4A]/30 transition-all duration-500">
              ...
              <a href={`mailto:${SITE.email}`} className="text-lg font-black text-[#C56A4A] hover:text-white transition-colors duration-300">
                {SITE.email}
              </a>
            </div>
            <div className="rounded-[2rem] p-8 bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500">
              ...
              <Link to="/insights" className="text-xs font-black uppercase tracking-widest text-white/40 hover:text-[#C56A4A] transition-colors duration-300">
                Browse insights →
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              to="/case-studies"
              className="px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest bg-white text-black hover:bg-[#C56A4A] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)]"
            >
              See the Results
            </Link>
            <Link
