...
export default function StudioPending() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-black selection:bg-[#00D4FF] selection:text-black relative overflow-hidden">
      {/* Background Accents */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-[20%] left-[20%] w-[60%] h-[60%] bg-[#00D4FF]/5 blur-[150px] rounded-full" />
      </div>
      ...
      <div className="max-w-xl text-center relative z-10">
        <div className="w-20 h-20 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-10 animate-pulse">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-[#00D4FF]"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        </div>
        ...
        <p className="text-lg font-medium text-white/40 mb-12 leading-relaxed">
          ...
          Elevation to <span className="text-[#00D4FF]">Editor Protocol</span> is required by a System Administrator to proceed.
        </p>
