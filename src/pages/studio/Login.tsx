...
export default function StudioLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-black selection:bg-[#C56A4A] selection:text-black">
      <Helmet>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#C56A4A]/10 rounded-full blur-[160px]" />
      </div>
        ...
        <div className="p-10 lg:p-12 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-xl">
          <form onSubmit={handle} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 rounded-2xl bg-[#C56A4A] text-black font-black text-sm uppercase tracking-widest hover:bg-white hover:scale-[1.02] transition-all duration-500 shadow-[0_0_30px_rgba(197,106,74,0.2)] disabled:opacity-50"
            >
          ...
          <button
            ...
            className="mt-8 text-[10px] font-black uppercase tracking-widest text-white/20 hover:text-[#C56A4A] transition-colors duration-300 w-full text-center"
          >
