  ...
  return (
    ...
    >
      <div className="space-y-24 mt-20">
        <section className="group relative p-10 lg:p-20 rounded-[3rem] bg-white/[0.03] border border-white/10 hover:border-[#C9A227]/30 transition-all duration-700 overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#C9A227] mb-8">Case Protocol 001</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm font-medium leading-relaxed text-[#C9A227]">Retention contribution reached 30% within 90 days. Meaningful lift in second-purchase velocity and reduced reliance on paid acquisition channels.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center py-20">
          ...
          <a href="/contact" className="text-xs font-black uppercase tracking-widest text-[#C9A227] hover:text-white transition-colors duration-300">
            Inquire for Feature →
          </a>
        </section>
      </div>
