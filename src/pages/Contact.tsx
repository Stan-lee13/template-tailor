      ...
      <div className="mt-20 space-y-24">
        <section className="p-10 lg:p-20 rounded-[3rem] bg-white/[0.03] border border-white/10 relative overflow-hidden group">
          ...
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-3xl lg:text-5xl font-black text-white tracking-tighter mb-8 leading-none uppercase">Priority <span className="text-gradient-warm">Access</span></h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button
                ...
                className="px-10 py-5 rounded-2xl bg-[#C56A4A] text-black text-xs font-black uppercase tracking-widest hover:bg-white transition-all duration-500 shadow-[0_0_30px_rgba(197,106,74,0.2)]"
              >
                Book Growth Audit
              </button>
              <a
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-lg font-medium text-white/40">
                Email: <a href={`mailto:${SITE.email}`} className="text-white hover:text-[#C56A4A] transition-colors">{SITE.email}</a>
              </p>
              <p className="text-lg font-medium text-white/40">
                LinkedIn: <a href={SITE.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#C56A4A] transition-colors">RetentionFirm Protocol</a>
              </p>
            </div>
          </div>
          <div className="space-y-6">
