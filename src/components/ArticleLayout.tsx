  ...
  return (
    <div className="rf-secondary-shell rf-secondary-shell--article min-h-screen selection:bg-[#C56A4A] selection:text-black">
      ...
      <main className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <article className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="flex items-center gap-6 mb-20 pb-12 border-b border-white/5">
            <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-xs font-black text-[#C56A4A]">
              RF
            </div>
            <div>
      ...
      <style>{`
        ...
        .rf-prose li::before { content: ''; position: absolute; left: -24px; top: 12px; width: 8px; height: 2px; background: #C56A4A; }
        .rf-prose blockquote { border-left: 4px solid #C56A4A; padding: 12px 0 12px 32px; margin: 64px 0; font-family: 'Outfit', sans-serif; font-size: 28px; color: #FFFFFF; line-height: 1.4; font-style: normal; font-weight: 900; letter-spacing: -0.04em; text-transform: uppercase; }
