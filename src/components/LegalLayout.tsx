    ...
    <div style={{ background: '#f1ece4', minHeight: '100vh' }}>
      ...
      <main style={{ padding: '140px clamp(20px, 5vw, 80px) 80px' }}>
        <article className="mx-auto" style={{ maxWidth: '720px' }}>
          ...
          <h1 className="font-outfit font-medium mb-2" style={{ fontSize: 'clamp(32px, 5vw, 56px)', color: '#0A0A0A', lineHeight: 1, letterSpacing: '-0.02em' }}>
            {title}
          </h1>
      ...
      <style>{`
        ...
        .rf-prose h2 { font-family: 'Outfit', sans-serif; font-weight: 500; font-size: 22px; color: #0A0A0A; margin-top: 36px; margin-bottom: 12px; letter-spacing: -0.01em; }
        .rf-prose h3 { font-family: 'Outfit', sans-serif; font-weight: 500; font-size: 17px; color: #0A0A0A; margin-top: 24px; margin-bottom: 8px; }
