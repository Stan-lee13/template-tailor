  ...
  return (
    <div className="rf-secondary-shell min-h-screen selection:bg-[#C56A4A] selection:text-black">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#C56A4A]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#D8A63D]/5 rounded-full blur-[120px]" />
      </div>
      ...
      <main className="relative pt-32 pb-24 px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-32 p-10 lg:p-16 rounded-[3rem] bg-gradient-to-br from-white/10 to-transparent border border-white/10 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#C56A4A]/10 rounded-full blur-[80px] -mr-32 -mt-32 group-hover:bg-[#C56A4A]/20 transition-colors duration-700" />

            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
              <div className="max-w-md">
                <h3 className="text-3xl lg:text-4xl font-black text-white mb-4 tracking-tight leading-none">
                  Stop the <span className="text-gradient-warm">Leaking Revenue.</span>
                </h3>
      ...
      <style>{`
        ...
        .rf-prose li::before { content: "→"; position: absolute; left: 0; color: #C56A4A; font-weight: 900; }
        .rf-prose a { color: #C56A4A; font-weight: 700; border-bottom: 2px solid rgba(197,106,74,0.2); transition: all 0.3s; }
        .rf-prose a:hover { border-bottom-color: #C56A4A; }
        .rf-prose strong { color: #FFFFFF; font-weight: 900; }
        .rf-prose blockquote { border-left: 4px solid #C56A4A; padding-left: 32px; font-style: italic; font-size: 24px; color: #FFFFFF; margin: 60px 0; }
      `}</style>
    </div>
  );
}
